    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Where does that leave a reader? This app writes from a Protestant evangelical position and takes the biblical testimony to be truthful: Scripture says the rite happened, says it repeatedly, and mostly says it about Israelites and Judahites rather than about foreigners at a safe distance — an accusation a national literature does not invent against itself. That is the article's position, and the archaeology neither confirms nor refutes it in the southern Levant, where the material evidence is genuinely thin. What should be resisted is the further claim, common in popular retellings, that Canaanite religion was defined by routine mass child sacrifice and that archaeology has proved it. That claim leans on Punic tophets a thousand miles away and centuries later, whose own interpretation is still contested in the journals. Two things are therefore true at once: the biblical witness is reliable, and the confident archaeological gloss usually laid over it is not. Among scholars generally the disagreement remains three-way — that the accusations preserve a real practice, that they are polemic against a rival cult, or that the rite existed only in extremity — and a reader should treat sweeping statements in either direction with suspicion."
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "This app takes the biblical account of the conquest as historical, and it is worth being clear about what that does and does not commit a reader to. It commits one to holding that Israel entered the land and that God gave it to them as Joshua describes. It does not commit one to any particular archaeological correlation, and evangelical scholars differ widely on the dating — the early exodus date of around 1446 BC and the late date of around 1260 BC are both defended within evangelicalism, and they imply different sites and different layers. Nor does it commit one to overstating a weak case: the honest position is that Hazor supports the narrative well, Jericho and Ai do not currently correlate, and a reader is better served by that than by a tidier story.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "This app writes from a Protestant evangelical position, and on the Sabbath that position starts with a distinction: the fourth commandment's abiding substance is not the same thing as the Mosaic Sabbath's ceremonial form. The substance — that time belongs to God, that human beings are made to rest as well as work, and that rest is a gift rather than a grudging allowance — stands, and it is grounded in creation itself, before Sinai and before Israel (Genesis 2:2-3). The form — the seventh day kept on pain of death as the covenant sign between God and Israel (Exodus 31:13-17) — belonged to that covenant, and the New Testament treats it as fulfilled in Christ. Colossians 2:16-17 is the load-bearing text: Sabbath days are 'a shadow of the things to come; but the body is Christ's.' Hebrews 4:9-10 completes the thought by making the rest itself the destination — 'There remains therefore a Sabbath rest for the people of God.' On this reading Christ does not abolish the Sabbath; he is what it was pointing at.",
          "Two practical conclusions follow, and most evangelicals hold both. First, no particular day binds the Christian conscience, because Paul says so directly and declines to arbitrate: 'One man esteems one day as more important. Another esteems every day alike. Let each man be fully assured in his own mind' (Romans 14:5-6). Second, Christians nevertheless gather, and they have gathered on the first day of the week since the apostolic period, in commemoration of the resurrection — the disciples breaking bread 'on the first day of the week' (Acts 20:7), and John 'in the Spirit on the Lord's day' (Revelation 1:10). Sunday is kept as the Lord's Day, joyfully and by long practice, rather than as a Sabbath transferred by command.",
        ],
      },
      {
        heading: "Where Evangelicals Themselves Differ",
        paragraphs: [
          "Stating a position is not the same as pretending there is only one, and the Sabbath is the clearest case in this app of a question evangelicals argue among themselves. All three views below are held by people with the same confidence in Scripture's authority, and none of them is treated by the others as a test of orthodoxy.",
          "The confessional Reformed view holds that the fourth commandment is moral law, binding on all people in every age, and that its observance was moved by apostolic authority to the first day. This is the position of the Westminster Confession, which calls the Lord's Day 'the Christian Sabbath' and asks for a day set apart from ordinary work and recreation. It is the historic Puritan and Presbyterian position, it is still confessionally binding in a number of denominations, and it reads the fulfilment argument above as conceding too much.",
          "The fulfilment view — the majority evangelical position today, and the one this article states above — treats the Sabbath as ceremonial and fulfilled, keeps Sunday as apostolic custom rather than command, and reads Colossians 2 and Romans 14 as settling the matter of days in principle. Its critics within evangelicalism answer that this leaves the only commandment of the ten without continuing force, which ought to give a Protestant pause.",
          "The seventh-day view holds that the commandment was never repealed and that the day was never changed. It is worth being precise here, because this position is often described as though it sat outside the evangelical camp: Seventh Day Baptists have held it since the seventeenth century, and Seventh-day Adventists — who affirm Scripture's authority, the Trinity, and salvation by grace through faith in Christ — are the largest body holding it today. They point out that Exodus 31:16 calls the sign 'a perpetual covenant,' and that no New Testament text records a command transferring the day.",
          "That last point is worth stating plainly on its own, because every side uses it: the New Testament contains no passage that explicitly commands a change of day. Those who keep Sunday read the transfer out of apostolic practice; those who keep Saturday read the same silence as decisive the other way. The argument turns on inference from practice, not on an explicit instruction, and a reader should know that before being told the question is easy.",
        ],
      },
      {
        heading: "How Other Traditions Read It",
        paragraphs: [
          "Roman Catholic teaching is frequently misrepresented on this point by Protestants, so it is worth quoting rather than characterising. The Catechism of the Catholic Church distinguishes Sunday from the sabbath 'which it follows chronologically every week,' and says that 'for Christians its ceremonial observance replaces that of the sabbath,' while also holding that 'in Christ's Passover, Sunday fulfills the spiritual truth of the Jewish sabbath and announces man's eternal rest in God' (CCC 2175). The ground given is the resurrection — Sunday as both the first day of the new creation and 'the eighth day' (CCC 2174) — and the continuing moral obligation is described as one 'inscribed by nature in the human heart to render to God an outward, visible, public, and regular worship' (CCC 2176). Catholics are bound to attend Mass on Sundays and holy days. Evangelicals will disagree with the weight this places on the Church's authority to bind the practice; they should not repeat the old claim that Rome simply invented the change and admits it, because that is not what the Catechism says.",
