  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Almost everything now known about Canaanite religion from the inside comes from one accidental discovery. In 1928 a farmer ploughing near the Syrian coast broke into a tomb; French excavation under Claude Schaeffer began in the spring of 1929, and within days the first tablets appeared in an unknown script. The site was Ugarit, destroyed around 1190-1185 BC in the general collapse of the Late Bronze Age. The script proved to be a thirty-sign alphabetic cuneiform, whose abecedaries are the earliest direct evidence anywhere of a fixed alphabetical order — and was substantially deciphered between 1930 and 1932 by Hans Bauer, Edouard Dhorme and Charles Virolleaud working from Virolleaud's published copies.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Second, the physical evidence, which comes from the wrong people and the wrong century. The walled precincts called tophets, holding urns of cremated infant remains under dedicatory stelae, are at Carthage and other Punic sites in Tunisia, Sicily and Sardinia — Phoenician colonies in the western Mediterranean, in use from about 800 BC onward, centuries after the Canaanites of the biblical period and a thousand miles away. Whether even those represent sacrifice is argued in the journals to this day: Jeffrey Schwartz and colleagues have read the ages at death as consistent with ordinary perinatal mortality, making the precinct an infant cemetery, while Patricia Smith and colleagues have argued that the analysis fails to allow for the shrinkage of bone in cremation, and Paolo Xella and colleagues have argued from the epigraphic, literary and archaeological evidence together that the complete absence of adults and older children is inexplicable in a normal cemetery. A separate caution, standard since the 1970s, is that the Greek and Roman writers who describe Carthaginian child sacrifice were Carthage's wartime enemies — though Josephine Quinn, who holds the practice to be real, has pushed back on that reading, noting that the ancient writers treated it as an oddity rather than an atrocity and that the propaganda thesis is largely a 20th-century scholarly construction.",
          "Third, Canaan itself, where the evidence is thin. No tophet has been identified in the Valley of Hinnom or anywhere else in Israel or Judah; for Jerusalem we depend on the biblical description. The most-cited southern Levantine find, jars of infant bones excavated by R. A. S. Macalister at Gezer early in the 20th century, rests on methods no longer regarded as adequate and is not accepted as demonstrated. A number of scholars have argued that where the rite did occur it was likely an emergency measure under military crisis rather than routine practice — which is how the one narrated instance in Scripture reads, the king of Moab sacrificing his heir on the city wall as his defence collapses (2 Kings 3:27).",
