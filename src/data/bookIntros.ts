...
{
    book: "Genesis",
    writtenWhen: "Tradition places the composition in the mid-second millennium BC, during the lifetime of Moses (roughly the 15th–13th centuries BC). Most critical scholars instead see Genesis as a composite work assembled from earlier sources over centuries, reaching its final form during or after the Babylonian exile (around the 6th–5th centuries BC).",
    author: "Jewish and Christian tradition attributes Genesis, and the whole Pentateuch, to Moses. Mainstream critical scholarship, following the Documentary Hypothesis (the J, E, and P sources), views it as woven together from multiple authors and traditions rather than penned by a single hand.",
    whyWritten: "Genesis functions as the foundational story of the world and of Israel, answering the deepest questions of origins: where creation, humanity, sin, death, and the nations came from, and how one family was chosen to be a blessing to all peoples. It grounds Israel's identity in a covenant God made with their ancestors Abraham, Isaac, and Jacob. Read as prologue to the rest of the Torah, it sets up the promises of land, descendants, and blessing that drive the entire biblical narrative.",
    summary: [
  ...
  },
  {
    ...
    author: "Traditionally attributed to Moses, who is the central human figure of the narrative. Critical scholars typically analyze Exodus as a blend of the J, E, and P sources rather than the work of a single author.",
    ...
    manuscripts: [
      ...
      "Egyptian records and archaeology illuminate the setting: the store-cities and brick-making labor described in Exodus 1 and 5 fit known New Kingdom building projects, and Egyptian texts attest to Semitic laborers, though no Egyptian source directly records the exodus itself.",
  ...
  {
    book: "Leviticus",
    writtenWhen: "Tradition assigns Leviticus to the Mosaic era in the second millennium BC, during Israel's time at Sinai. Critical scholars associate most of the book with the Priestly source (P) and a related 'Holiness' tradition (H, chapters 17–26), often dated to the exilic or post-exilic period, while acknowledging that it preserves older ritual material.",
    author: "Traditionally attributed to Moses, to whom God speaks throughout the book. Critical scholarship identifies the bulk of Leviticus with priestly writers and editors rather than a single Mosaic author.",
  ...
  },
  {
    ...
    manuscripts: [
      ...
      "Comparisons among the Hebrew, Greek, and Samaritan traditions reveal Numbers as a book where the Samaritan and some Qumran copies preserve a notably expanded form, illustrating the fluidity of the Pentateuchal text before standardization."
    ]
  },
  {
    book: "Deuteronomy",
    writtenWhen: "Tradition dates Deuteronomy to the end of Moses's life in the second millennium BC, delivered on the plains of Moab. Many critical scholars connect the book's core to the law scroll discovered in the Jerusalem temple during King Josiah's reforms around 622 BC (2 Kings 22), viewing it as a 7th-century composition (the 'D' source) later expanded during and after the exile.",
    author: "Traditionally attributed to Moses, whose farewell speeches form the bulk of the book. Critical scholarship identifies Deuteronomy as the product of a distinct author or 'Deuteronomistic' school, often associated with the reform movement of Josiah's era.",
    whyWritten: "Deuteronomy is presented as Moses's final addresses to Israel before his death and their entry into the Promised Land, restating and applying the covenant law for a new generation. It urges wholehearted love and loyalty to the one God, warns against idolatry, and frames obedience and disobedience in terms of blessing and curse, life and death. It aims to shape Israel's memory, worship, and national life around exclusive devotion to YHWH.",
    summary: [
    ...
    keyPassages: [
      ...
      { label: "A prophet like Moses promised", chapter: 18, verse: 15 },
...
{
    book: "Joshua",
    writtenWhen: "Jewish tradition places its composition in the late 13th–12th century BC, near the events it describes. Most critical scholars regard it as part of the Deuteronomistic History, compiled from older sources and reaching its present form during or after the Babylonian exile (7th–6th century BC).",
    author: "The Talmud attributes the book largely to Joshua himself, with the account of his death added by Eleazar and Phinehas. Critical scholarship sees it as the work of anonymous Deuteronomistic editors who shaped Deuteronomy through 2 Kings into a unified history.",
    ...
    manuscripts: [
      ...
      "Excavations at sites such as Jericho (Tell es-Sultan) and Ai (commonly identified with et-Tell) have produced results that scholars debate vigorously, since the archaeological picture of destruction layers and occupation gaps does not straightforwardly match the biblical conquest narrative.",
  ...
  },
  {
    ...
    author: "Jewish tradition (the Talmud) names Samuel as the author. Modern scholarship attributes the book to anonymous editors within the Deuteronomistic History, who wove together independent hero stories with a recurring theological framework.",
    ...
    summary: [
      ...
      "The central body (chapters 3:7–16) recounts the exploits of the judges—Othniel, Ehud, Deborah and Barak, Gideon, Jephthah, Samson, and others—each a charismatic deliverer rather than a dynastic ruler. The stories grow progressively darker and the leaders more flawed.",
    ...
    manuscripts: [
      "Fragments of Judges were found among the Dead Sea Scrolls at Qumran (including 1QJudg and 4QJudg-a), with 4QJudg-a notably lacking a passage present in the Masoretic Text, suggesting the book underwent editorial expansion.",
  ...
  {
    book: "Ruth",
    writtenWhen: "The events are set 'in the days when the judges ruled' (c. 12th–11th century BC). Its composition is debated: some date it early (near the monarchy's beginning, given its interest in David's ancestry), while many critical scholars favor a post-exilic date, partly on linguistic grounds and its themes of inclusion.",
    author: "The Talmud attributes Ruth to Samuel. The book itself is anonymous, and scholars generally treat the author as unknown, noting the skilled narrative artistry that shapes the short story.",
  ...
  },
  {
    ...
    whyWritten: "2 Samuel is the story of David's reign—his triumphs, his covenant with God, and his grievous failures. It establishes the theological foundation of the Davidic covenant, God's promise of an enduring dynasty, while honestly portraying the sin and family turmoil that followed David's adultery. The book shows that God's promise endures despite the king's flaws.",
    summary: [
    ...
    keyPassages: [
      ...
      { label: "The Davidic covenant—an everlasting throne", chapter: 7 },
    ...
    manuscripts: [
      ...
      "The Mesha Stele (Moabite Stone, 9th century BC) references Israelite control and conflict over Moab and Israel's kings, consistent with the broader picture of Davidic-era expansion and later relations with neighboring peoples.",
  ...
  {
    book: "1 Kings",
    writtenWhen: "The events run from Solomon's accession (c. 970 BC) through the mid-9th century BC. Critical scholars view 1–2 Kings as the culmination of the Deuteronomistic History, compiled from royal and prophetic sources with a first edition possibly in Josiah's reign (late 7th century BC) and a final edition during the exile.",
  ...
  {
    book: "2 Kings",
    writtenWhen: "The events extend from the mid-9th century BC to the Babylonian exile (586 BC and its immediate aftermath). Critical scholars see it as the closing portion of the Deuteronomistic History, with a final edition compiled during the exile, since the book ends with the fall of Jerusalem and a note from the exilic period.",
  ...
  },
  {
    ...
    whyWritten: "1 Chronicles retells Israel's story from Adam through David for the restored community after the exile, emphasizing continuity with the past and the centrality of proper worship. It idealizes David, focusing on his preparations for the Temple and the organization of worship rather than his failures. The book reassures a small, rebuilding community that they remain God's people, heirs of the promises to David.",
    summary: [
  ...
  },
  {
    ...
    author: "Traditionally attributed to Ezra, as with 1 Chronicles. Critical scholarship again refers to the anonymous 'Chronicler,' who rewrote the history of Judah's monarchy from a Temple-centered, post-exilic perspective.",
    ...
    manuscripts: [
      ...
      "The Chronicler's account of Judah's kings parallels 1–2 Kings, and comparison reveals a consistent theological reworking that heightens the Temple's importance and rewards or punishes kings more immediately for their faithfulness.",
      ...
      "The Babylonian Chronicles record Nebuchadnezzar's conquests of Judah, corroborating the fall of Jerusalem with which the book closes.",
  ...
  },
  {
    ...
    manuscripts: [
      ...
      "The Greek textual tradition preserves an alternate version known as 1 Esdras, which recounts overlapping material from Chronicles, Ezra, and Nehemiah in a different arrangement, showing the fluid literary history of this restoration material."
    ]
  },
  {
    book: "Nehemiah",
  ...
  {
    book: "Esther",
    writtenWhen: "Set during the reign of the Persian king Ahasuerus, generally identified with Xerxes I (486–465 BC). The book was likely composed somewhat later in the Persian or early Hellenistic period; scholars debate the exact date, with many favoring the 4th–3rd century BC.",
    ...
    manuscripts: [
      ...
      "The Greek Septuagint version of Esther contains six substantial 'Additions'—including prayers and an explicit naming of God—absent from the Hebrew text, which are preserved in Catholic and Orthodox Bibles and set apart in Protestant tradition.",
  ...
  },
{
    ...
    author:
      "The book is anonymous; ancient Jewish tradition (the Talmud) variously ascribed it to Moses, while others left it unattributed. Modern scholarship treats the author as an unknown Israelite poet of exceptional literary skill, and some argue the prose frame (chapters 1-2, 42) and the poetic dialogues may come from different hands or stages.",
    whyWritten:
    ...
    summary: [
      "The book opens with a prose prologue in the heavenly court, where 'the Satan' (the Accuser) challenges whether Job's piety is merely self-interested. God permits Job to be stripped of his children, wealth, and health, yet Job does not curse God. This sets up the central test: is faith possible when it brings no reward?",
      ...
      "The climax comes when the Lord answers Job out of the whirlwind (chapters 38-41), overwhelming him with questions about creation, the wild animals, and the great creatures Behemoth and Leviathan—never explaining the wager, but revealing the vastness of divine wisdom. Job responds in humble repentance.",
    ...
    keyPassages: [
      { label: "The heavenly wager and Job's calamities", chapter: 1 },
    ...
    manuscripts: [
      ...
      "The book's archaic language, place names, and setting in the land of Uz (associated with Edom or the Arabian region) reflect a deliberately non-Israelite, patriarchal milieu.",
    ],
  },
  {
    book: "Psalms",
    ...
    author:
      "About half the psalms carry a Davidic superscription ('a psalm of David'), and tradition credits David as the principal psalmist. Others are attributed to Asaph, the sons of Korah, Solomon, Moses (Psalm 90), Heman, and Ethan, while many are anonymous. Critical scholars debate whether the Hebrew phrase means authorship by, dedication to, or simply association with these figures.",
    whyWritten:
      "The Psalms are Israel's inspired hymnbook and prayer book—songs for worship in the temple, for pilgrimage, for the king's coronation, and for the full range of human experience before God. They give voice to praise, thanksgiving, lament, confession, trust, and complaint, teaching God's people how to speak honestly to God in every season. Across the collection they also proclaim God's kingship, his covenant faithfulness, and hopes that later readers understood as pointing to the Messiah.",
    summary: [
    ...
    manuscripts: [
      "The Great Psalms Scroll (11QPsa) from Qumran Cave 11 is the most extensive Psalms manuscript among the Dead Sea Scrolls; it preserves a different arrangement of psalms than the Masoretic order and includes additional compositions, such as Psalm 151 (known from the Septuagint) and other non-canonical psalms.",
  ...
  },
  {
    ...
    manuscripts: [
      ...
      "A section of Proverbs (roughly chapters 22-24, 'the sayings of the wise') shows notable parallels to the Egyptian 'Instruction of Amenemope,' an earlier wisdom text; the relationship illustrates how Israel's wisdom shared forms and themes with the broader ancient Near East.",
  ...
  },
  {
    book: "Ecclesiastes",
    writtenWhen:
      "Traditionally dated to Solomon's reign (10th century BC), based on the self-description as 'son of David, king in Jerusalem.' On linguistic grounds—its late Hebrew vocabulary, Aramaic influence, and possible Persian loanwords—most critical scholars date the book much later, to the post-exilic period (roughly 5th-3rd century BC).",
    author:
      "The narrator calls himself 'Qoheleth' (traditionally rendered 'the Preacher' or 'the Teacher'), 'son of David, king in Jerusalem,' which points to Solomon. Because the book is not explicitly named as Solomon's and its language appears late, many scholars regard the Solomonic persona as a literary device adopted by a later anonymous sage to explore life's meaning through the figure of the wisest king.",
    whyWritten:
  ...
  },
  {
    ...
    writtenWhen:
      "Traditionally linked to Solomon (10th century BC), whose name appears in the title. On linguistic grounds—including late Hebrew forms, an Aramaic-influenced vocabulary, and a possible Persian and Greek loanword—many critical scholars date the book's final form to the post-exilic period (roughly 5th-3rd century BC), while noting some material may be older.",
    author:
    ...
    manuscripts: [
      ...
      "The book's Hebrew includes late linguistic features and loanwords (Aramaic influence, and words often identified as Persian and Greek in origin) that many scholars weigh against Solomonic authorship and toward a later date.",
  ...
  },
{
    ...
    author: "Tradition credits the entire book to Isaiah son of Amoz, a prophet active in Jerusalem in the 8th century BC. Since the late 18th century, many critical scholars have proposed multiple authors or a school of disciples continuing his tradition—commonly labeled First Isaiah (1–39), Second/Deutero-Isaiah (40–55), and Third/Trito-Isaiah (56–66)—largely because chapters 40 onward name Cyrus of Persia and presuppose the exile as a present reality. Those who defend unity point to the book's shared vocabulary, its 'Holy One of Israel' motif throughout, and the New Testament's treatment of it as one prophet's work.",
    ...
    manuscripts: [
      ...
      "The scroll contains no chapter or verse divisions (those are later editorial conventions) and interestingly runs continuously from chapter 39 into chapter 40 with no break, a detail relevant to debates over the book's composition.",
  ...
  },
  {
    ...
    author: "Tradition attributes the book to the prophet Jeremiah son of Hilkiah, a priest from Anathoth, with his scribe Baruch son of Neriah recording his words (Jeremiah 36 describes this dictation). Critical scholarship largely accepts a core of genuine Jeremiah material—especially the poetic oracles—but attributes much of the prose sermons and biographical narrative to Baruch and later editors who shaped and expanded the collection.",
  ...
  },
  {
    ...
    author: "Tradition, reflected in the Greek and Latin versions and in the Talmud, attributes the book to the prophet Jeremiah, who is portrayed as mourning the fallen city. The Hebrew text itself is anonymous, and many modern scholars leave the author unnamed, noting differences in style and outlook from the book of Jeremiah while affirming it comes from someone who witnessed the fall of Jerusalem.",
  ...
  {
    book: "Daniel",
    writtenWhen: "Traditionally the book is dated to the 6th century BC, set during the Babylonian and early Persian empires (roughly 605–530 BC), and understood as written by Daniel himself in that era. Many critical scholars date the book's final form to the 2nd century BC, around 165 BC during the Maccabean crisis under Antiochus IV Epiphanes, chiefly because the visions in chapters 10–12 describe the Hellenistic period and the persecutions of Antiochus with striking specificity.",
    ...
    summary: [
      ...
      "The second half (chapters 7–12) shifts to apocalyptic visions granted to Daniel himself. He sees four beasts rising from the sea, a ram and a goat, and receives the enigmatic prophecy of 'seventy weeks,' along with a detailed panorama of conflicts between northern and southern kingdoms. These visions portray a succession of empires giving way at last to an everlasting kingdom and 'one like a son of man.'",
    ...
    keyPassages: [
      ...
      { label: "Vision of one like a son of man", chapter: 7, verse: 13 },
      { label: "The seventy weeks prophecy", chapter: 9, verse: 24 },
...
{
    book: "Hosea",
    writtenWhen: "Traditionally and by most scholars dated to the mid-to-late 8th century BC, roughly 750–722 BC, during the final decades of the northern kingdom of Israel before its fall to Assyria. Some passages referencing Judah are thought by critical scholars to be later editorial additions.",
    author: "Traditionally attributed to the prophet Hosea son of Beeri, who ministered in the northern kingdom. Most scholars accept a genuine 8th-century prophetic core, while noting that later editors (likely in Judah) shaped and supplemented the collection.",
  ...
  {
    book: "Joel",
    writtenWhen: "The dating of Joel is notably uncertain and debated: proposals range from a pre-exilic 9th-century setting to a post-exilic date in the 5th–4th centuries BC. Because the book names no king and references the temple as functioning, many scholars now favor a post-exilic date, though certainty is impossible.",
  ...
  {
    book: "Amos",
    writtenWhen: "Dated to the mid-8th century BC, around 760–750 BC, during the reigns of Jeroboam II of Israel and Uzziah of Judah — a time of prosperity but deep social injustice. This traditional dating is broadly accepted by scholars, who see a genuine 8th-century core with some later editorial touches.",
    author: "Attributed to Amos, a shepherd and tender of sycamore figs from Tekoa in Judah who was called to prophesy in the northern kingdom of Israel. Most scholars accept the historical Amos as the source of the book's core oracles, with later editing (such as the closing promise of restoration) sometimes debated.",
  ...
  {
    book: "Jonah",
    writtenWhen: "The prophet Jonah lived in the 8th century BC (mentioned in 2 Kings 14:25 during Jeroboam II's reign), but the date of the book's composition is debated: traditional views place it in that era, while many scholars date the written narrative later, perhaps in the post-exilic period, reading it as a didactic story. The range of scholarly opinion is wide.",
    author: "The book concerns Jonah son of Amittai but is written about him in the third person, so its actual author is anonymous. Traditional attribution links it to Jonah himself; critical scholarship generally regards it as an anonymous later composition using the historical prophet as its subject.",
    whyWritten: "Jonah tells the story of a reluctant prophet sent to preach to Israel's fearsome enemy, the great city of Nineveh — and his shocking anger when God spares it. The book's purpose is to challenge narrow nationalism and to reveal the breadth of God's compassion, which extends even to Israel's enemies and to the whole creation. It is as much about the prophet's stubborn heart as about Nineveh's repentance.",
    summary: [
      "Commanded to preach against Nineveh, Jonah flees in the opposite direction by ship. God sends a violent storm; Jonah is thrown overboard at his own request and swallowed by a great fish, in whose belly he prays a psalm of thanksgiving before being vomited onto dry land.",
    ...
    keyPassages: [
      ...
      { label: "Jonah swallowed by the great fish", chapter: 1, verse: 17 },
      { label: "Jonah's prayer from inside the fish", chapter: 2, verse: 1 },
      { label: "Nineveh repents and God relents", chapter: 3, verse: 10 },
    ...
    manuscripts: [
      ...
      "The full Masoretic text of Jonah survives in the Aleppo and Leningrad Codices."
    ]
  },
  {
    book: "Micah",
    writtenWhen: "Dated to the late 8th century BC, roughly 740–700 BC, during the reigns of Jotham, Ahaz, and Hezekiah of Judah — making Micah a contemporary of Isaiah. Scholars widely accept an 8th-century core, while debating whether some passages of hope and restoration were added by later editors.",
    author: "Attributed to Micah of Moresheth, a town in the Judean lowlands, who prophesied against both Israel and Judah. Most scholars accept the prophet Micah as the source of the book's core, with ongoing discussion about later editorial expansion.",
  ...
  },
  {
    ...
    author: "Attributed to the prophet Habakkuk, of whom nothing is known beyond this book. Scholars generally treat the book as the work of a genuine prophet of this period, while sometimes discussing whether the concluding psalm (chapter 3) was composed separately.",
    ...
    manuscripts: [
      ...
      "Notably, the Habakkuk Pesher covers only chapters 1–2 and not the psalm of chapter 3, a fact that features in scholarly discussion of that chapter's transmission.",
  ...
  {
    book: "Zephaniah",
    writtenWhen: "Dated to the 7th century BC during the reign of King Josiah of Judah (640–609 BC), as stated in the book's opening verse — likely early in Josiah's reign, before or during his reforms. This setting is broadly accepted by scholars.",
    author: "Attributed to Zephaniah, whose genealogy is traced back four generations to a certain Hezekiah, possibly the king. Scholars generally accept a 7th-century prophetic core, with some discussion of later editorial shaping.",
  ...
  },
  {
    ...
    author: "Attributed to the prophet Zechariah son of Berechiah, a contemporary of Haggai. Critical scholarship widely distinguishes chapters 1–8 as Zechariah's own from chapters 9–14, which are often thought to come from later hands, though the traditional view maintains single authorship.",
  ...
  },
  {
    ...
    manuscripts: [
      ...
      "The Wadi Murabba'at Minor Prophets scroll (Mur88) contains Malachi within its continuous Hebrew text of the Twelve, dating to around the early 2nd century AD.",
  ...
  },
{
    book: "Matthew",
    writtenWhen:
      "Church tradition placed Matthew early, sometimes in the 50s or 60s AD, and held it may have originally circulated in a Hebrew or Aramaic form. Most critical scholars date the Greek Gospel we have to roughly 80–90 AD, after the fall of Jerusalem in 70 AD, partly because it appears to draw on the Gospel of Mark.",
    author:
      "Tradition attributes this Gospel to Matthew (also called Levi), the tax collector whom Jesus called to follow him. Because the finished Gospel is written in polished Greek and seems to depend on Mark as a source, many critical scholars think it was composed by an anonymous author or community in the Matthean tradition rather than penned directly by the apostle, though the traditional view still has defenders.",
    whyWritten:
  ...
  },
  {
    ...
    summary: [
      ...
      "The Gospel ends with the women finding the empty tomb and a young man announcing that Jesus has risen. In the earliest and most reliable manuscripts the account stops suddenly at 16:8 with the women afraid; later manuscripts add a 'longer ending' (16:9–20), which most scholars regard as a subsequent addition rather than part of Mark's original text.",
    ],
    keyPassages: [
    ...
    manuscripts: [
      ...
      "Because Mark, Matthew, and Luke overlap so heavily, Mark sits at the center of the 'Synoptic Problem'; the widely held theory of 'Markan priority' holds that Mark was written first and used as a source by both Matthew and Luke, alongside a hypothetical sayings source called 'Q.'",
  ...
  },
  {
    book: "Luke",
    writtenWhen:
      "Traditional dating places Luke in the 60s AD, sometimes tied to Paul's imprisonment in Rome. Many critical scholars date it to around 80–90 AD, since Luke appears to use Mark as a source and seems aware of Jerusalem's destruction in 70 AD.",
    author:
    ...
    manuscripts: [
      ...
      "Luke shares much material with Matthew and Mark, placing it within the 'Synoptic Problem'; most scholars think Luke drew on Mark and on a hypothetical sayings source ('Q'), while also including a substantial body of material unique to Luke.",
  ...
  },
  {
    book: "John",
    writtenWhen:
      "Traditional dating puts John's Gospel late in the first century, commonly around 90–100 AD, as the last of the four to be written. Critical scholars generally agree with a date in the 90s AD, and many think the Gospel reached its final form in stages within a community over time.",
    author:
      "Tradition attributes the Gospel to John the son of Zebedee, identified with the unnamed 'disciple whom Jesus loved.' Critical scholarship debates whether it was written by the apostle himself, by a later disciple or 'Johannine community' that preserved his testimony, or through several stages of editing, and there is no consensus, though the Gospel presents itself as rooted in eyewitness testimony.",
    whyWritten:
    ...
    summary: [
      ...
      "John's Jesus speaks in long, reflective discourses rather than short parables, and the Gospel emphasizes themes of light and darkness, belief and unbelief, life, truth, and love. The narrative repeatedly shows people responding to Jesus with either faith or rejection as his claims grow more explicit and the opposition intensifies.",
    ...
    manuscripts: [
      "Papyrus 52 (P52), the Rylands Library Papyrus, is a small fragment containing a few verses from John chapter 18; usually dated to the first half of the 2nd century, it is among the earliest known fragments of any New Testament text and shows John was already circulating widely by then.",
  ...
  },
  {
    book: "Acts",
    writtenWhen:
      "Traditional dating sometimes places Acts in the early 60s AD, since the narrative ends with Paul still under house arrest in Rome and does not mention his death. Many critical scholars date it later, around 80–90 AD, as the second volume written after the Gospel of Luke.",
    author:
  ...
  },
{
  ...
  },
  {
    ...
    author: "The letter presents itself as written by Paul, and many scholars accept it as authentically Pauline, perhaps composed with the help of a secretary. Others regard it as pseudonymous — written by a later disciple in Paul's name and tradition — pointing to its distinctive vocabulary and long, flowing sentences, its more developed theology of the church, and its close literary relationship to Colossians. The question remains genuinely debated, and both views are held by serious scholars.",
  ...
  },
  {
    ...
    summary: [
      ...
      "At the letter's center stands the great 'Christ hymn,' which traces Jesus' humility — emptying himself, taking the form of a servant, and obeying even to death on a cross — followed by his exaltation to the highest place. Paul holds this up as the model for the mind believers should have toward one another.",
    ...
    keyPassages: [
      ...
      { label: "The Christ hymn (kenosis)", chapter: 2, verse: 5 },
  ...
  },
  {
    ...
    author: "The letter claims Paul as author, with Timothy as co-sender, and many scholars accept it as genuinely Pauline, possibly written with significant help from a secretary. Others consider it pseudonymous, noting differences from the undisputed letters in vocabulary and style and a somewhat more developed view of Christ and the church. Its close ties to Philemon, which is undisputedly Pauline, are often taken to support authenticity. The matter remains debated.",
    whyWritten: "Paul (or a close associate) wrote to a church he had not personally founded, likely started through his coworker Epaphras, to counter a dangerous teaching taking root there. This 'Colossian heresy' appears to have blended Christian faith with other elements — ascetic rules, the worship of angels or cosmic 'powers,' special visions, and observance of religious festivals. Against it, the letter proclaims the complete supremacy and sufficiency of Christ, in whom the fullness of God dwells, so that believers need nothing added to him.",
    summary: [
  ...
  },
  {
    ...
    author: "The letter presents itself as from Paul, Silvanus, and Timothy, and many scholars accept it as authentically Pauline. Others argue it is pseudonymous, pointing to differences in tone and to its teaching on end-times events, which some see as diverging from the imminent expectation of the first letter. Its strong similarities to 1 Thessalonians are read by some as a sign of authenticity and by others as imitation. The question remains genuinely open.",
    ...
    manuscripts: [
      "2 Thessalonians is contained in the great fourth- and fifth-century uncial codices Sinaiticus, Vaticanus, and Alexandrinus.",
      "As a short letter, its earliest attestation comes bundled within the broader Pauline-corpus manuscripts rather than in distinctive early fragments of its own.",
  ...
  },
  {
    ...
    author: "The letter claims to be from Paul to his coworker Timothy. Along with 2 Timothy and Titus, it forms the 'Pastoral Epistles,' whose authorship is the most debated in the Pauline corpus. Some scholars accept Pauline authorship, perhaps with a secretary given significant freedom, and place it after the events narrated in Acts. Others judge it pseudonymous, citing distinctive vocabulary and style, a church structure that seems more developed, and a historical setting difficult to fit into Paul's known travels. Both positions are held by reputable scholars.",
    ...
    keyPassages: [
      ...
      { label: "Qualifications for overseers and deacons", chapter: 3 },
  ...
  },
  {
    ...
    author: "The letter claims to be Paul's, and it is the most personal and moving of the three Pastoral Epistles. As with 1 Timothy and Titus, authorship is debated: some accept it as genuinely Pauline — reading it as his farewell testament, possibly shaped by a secretary — while others regard it as pseudonymous on grounds of vocabulary, style, and setting. Of the three Pastorals, its intimate, personal tone leads some scholars to view it as the most likely to preserve authentic Pauline material. The debate is genuine.",
  ...
  },
  {
    ...
    author: "The letter claims to be from Paul to his coworker Titus. As one of the three Pastoral Epistles, its authorship is debated on the same grounds as 1 and 2 Timothy — some scholars affirm Pauline authorship, possibly through a secretary, while others consider it pseudonymous because of its vocabulary, style, and the developed church organization it assumes. The three Pastorals are usually treated together in this discussion.",
  ...
  },
  {
    ...
    manuscripts: [
      "As a very short, personal letter, Philemon has no distinctive early papyrus fragments of its own; its earliest attestation comes bundled within the broader Pauline-corpus manuscripts.",
      "Philemon is contained in the great fourth- and fifth-century uncial codices Sinaiticus, Vaticanus, and Alexandrinus, which preserve the complete Pauline collection.",
  ...
  },
{
  ...
  },
  {
    ...
    summary: [
      ...
      "A major thread is the relationship between hearing and doing. James insists that his readers be 'doers of the word and not hearers only,' warning against a religion that is all talk. He confronts favoritism toward the rich, calls for compassion toward the poor, and delivers his famous teaching that faith without works is dead — a claim that has often been read alongside, and sometimes against, Paul's emphasis on faith.",
  ...
  {
    book: "2 Peter",
    writtenWhen: "If written by Peter, it dates to the mid-60s AD, shortly before his death, which the letter anticipates (1:14). Many critical scholars, however, regard it as pseudonymous and one of the latest-written books in the New Testament, possibly composed early in the second century.",
    author: "Traditionally the apostle Peter, presented as his farewell testament. Of all the New Testament letters, its authorship is among the most debated: critical scholars point to its markedly different Greek style from 1 Peter, its close literary relationship with Jude, and its apparent awareness of a collection of Paul's letters as reasons many consider it pseudonymous — a work written in Peter's name to preserve his teaching. Others defend traditional authorship, and the question remains genuinely contested.",
  ...
  },
  {
    ...
    manuscripts: [
      ...
      "The so-called 'Johannine Comma' — an explicitly Trinitarian phrase in some later texts of 1 John 5:7-8 — is absent from all the earliest Greek manuscripts and is regarded by scholars as a much later addition, a well-documented example of how textual criticism identifies material not original to a book.",
  ...
  },
  {
    ...
    summary: [
      ...
      "In heaping up his condemnation, Jude reaches for material from Jewish tradition beyond the Old Testament. He alludes to a dispute between the archangel Michael and the devil over the body of Moses — a story linked to the extra-biblical work known as the Assumption (or Testament) of Moses — and he directly quotes a prophecy from the Book of Enoch, a Jewish apocalyptic writing not part of the biblical canon. This use of extra-biblical Jewish literature is one of the most discussed features of the letter and has long shaped debates about its background and canonical status.",
  ...
  },
  {
    ...
    author: "The book identifies its author simply as 'John,' who writes while exiled on the island of Patmos. Tradition identifies him with the apostle John, also credited with the Gospel and the epistles. Critical scholars debate whether this is the same John, noting the significant differences in Greek style, grammar, and vocabulary between Revelation and the Gospel; some therefore distinguish a 'John of Patmos' or 'John the Elder' from the apostle, while the question remains open.",
