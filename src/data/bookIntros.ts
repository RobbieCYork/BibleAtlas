...
export const bookIntros: BookIntro[] = [
{
  ...
  {
    book: "Numbers",
    writtenWhen: "Tradition places Numbers in the Mosaic period of the second millennium BC, covering Israel's wilderness journey from Sinai to the plains of Moab. Evangelical scholars point to internal features consistent with a Mosaic-era core: the detailed census figures and tribal organization (chapters 1 and 26), the itemized forty-two-stage wilderness itinerary (chapter 33), which the text says Moses himself recorded 'at the LORD's command' (33:2), and Priestly legislation on sacrifice, purification, and festivals (chapters 15, 18–19, 28–29) that presupposes a functioning wilderness tabernacle rather than the Jerusalem temple. Critical scholarship instead treats Numbers as a composite of older narrative material (commonly assigned to the J and E sources) interwoven with substantial Priestly (P) content, reaching final form in the exilic or post-exilic period. That late dating of P is the same contested judgment noted at Leviticus's entry: Yehezkel Kaufmann, Avi Hurvitz, Jacob Milgrom, and Israel Knohl each argue for a pre-exilic origin of P material against Wellhausen's classic exilic dating — a live debate that applies as much to Numbers' priestly chapters as to Leviticus's.",
    author: "Traditionally attributed to Moses, consistent with the book's own note that Moses recorded the stages of Israel's journey at the LORD's command (33:2) and the Pentateuch's broader testimony to Mosaic writing (Exodus 17:14; 24:4; 34:27; Deuteronomy 31:9, 24). As in Exodus and Deuteronomy, the narrative is told in the third person and includes a notable aside about Moses himself — 'Now Moses was a very humble man, more so than anyone on the face of the earth' (12:3) — that many scholars, including some who affirm Mosaic authorship, read as a later editorial comment rather than Moses' own self-description. Critical scholars regard Numbers as an edited combination of the J, E, and P sources rather than a unified Mosaic composition, distinguishing them using the same criteria applied across the Pentateuch — divine-name usage, doublets (e.g., two separate accounts of water brought from a rock: Exodus 17:1–7 and Numbers 20:2–13), and stylistic variation — criteria whose adequacy for establishing independent documents remains disputed even within critical scholarship.",
  ...
  },
{
  ...
  {
    book: "Judges",
    writtenWhen: "Traditionally dated before David's capture of Jerusalem, c. 1003 BC, with the events spanning roughly the 12th–11th centuries BC. Critical scholars view it as a Deuteronomistic composition assembling older tribal traditions, edited into its final shape during the exilic or post-exilic period.",
  ...
  {
    book: "Ezra",
    writtenWhen: "Set in the Persian period, covering the return from exile beginning with Cyrus's decree (539/538 BC) onward. The book's internal chronology contains a genuine, long-debated crux: Ezra 7:7–8 dates Ezra's return to 'the seventh year of Artaxerxes,' but which Persian king of that name is meant is disputed, since it shifts Ezra's date — and Ezra's position relative to Nehemiah — by up to 60 years. The traditional view identifies him as Artaxerxes I, placing Ezra's mission in 458 BC, before Nehemiah's arrival in 445 BC; this reading takes Ezra 7's regnal reference and the book's narrative order at face value and is defended by most evangelical scholarship (e.g., Kitchen, Yamauchi, and the standard introductions of Archer and of Dillard & Longman). Some critical scholars instead identify him as Artaxerxes II, dating Ezra's actual mission to 398 BC, after Nehemiah; this view goes back to Van Hoonacker in the 1890s and is still engaged seriously in major commentaries such as Williamson's and Blenkinsopp's, resting on Nehemiah's silence about any prior work by Ezra and on arguments about the likely sequence of Jerusalem's civic (wall-building) and religious (law-reading) reforms. Composition of the book itself is generally dated to the later Persian period on either reconstruction; Ezra and Nehemiah were originally a single work.",
  ...
  },
{
    book: "Job",
    writtenWhen:
      "The events are set in a patriarchal age (Job's wealth measured in livestock, his priest-like role in his own household), which some connect to the era of the patriarchs. The book's actual composition is among the most disputed in the Old Testament, with three main proposals. An early date (patriarchal to Mosaic era) rests on the total absence of any reference to the Exodus, Sinai, the Law, the Levitical priesthood, or the monarchy; Job's own household priesthood (1:5); customs such as the qesitah currency (42:11, matching Genesis 33:19); and the patriarch-like extreme lifespans — read together as evidence the poem was composed close to the events it describes. A Solomonic date (used for this book's timeline placement) ties Job to the flowering of Israel's wisdom literature under Solomon, pointing to its affinities with Proverbs and Ecclesiastes and its participation in a broader ancient Near Eastern wisdom genre also seen in works such as the Babylonian 'Ludlul bel nemeqi' and the 'Babylonian Theodicy.' An exilic or post-exilic date (6th-4th century BC) points instead to Aramaic-influenced vocabulary in the Hebrew text, thematic parallels to the suffering and theodicy concerns of Isaiah 40-55, and the legal 'rib' (lawsuit) motif common in later prophetic and wisdom writing. Many scholars conclude the book took shape over a long span, with an ancient core reworked by a later poet.",
    author:
  ...
  },
  {
    book: "Proverbs",
    writtenWhen:
      "Traditionally associated with the reign of Solomon (10th century BC), whose court is credited with the core collections; the book itself notes that some Solomonic proverbs were later copied out 'by the men of Hezekiah king of Judah' (c. 700 BC). Critical scholarship sees Proverbs as an anthology gathered and edited over several centuries, reaching its final form in the post-exilic period. That case draws partly on the parallels between 22:17-24:22 and the Egyptian 'Instruction of Amenemope' (see Manuscripts), on the personified 'Woman Wisdom' of chapter 8—read by many scholars as anticipating the more developed wisdom figures of later Second Temple works like Sirach and the Wisdom of Solomon—and on the closing chapters' inclusion of the non-Israelite sages Agur and Lemuel (30:1; 31:1), taken as a sign of the book's broad, multi-generational compilation.",
    author:
  ...
  },
{
  ...
  {
    book: "Galatians",
    writtenWhen: "Dated somewhere between roughly AD 48 and 55; the exact date depends on whether Paul wrote to churches in the south of the region of Galatia (the South Galatian view — Ramsay, F. F. Bruce, Longenecker — pointing to the province cities evangelized in Acts 13-14, which would date the letter as early as AD 48-49, possibly Paul's earliest, before the Jerusalem Council of Acts 15) or to the ethnic region further north (the North Galatian view — Lightfoot, Betz — evangelized later, dating the letter after the Council, c. AD 53-55). Some place it very early, possibly making it one of Paul's first letters.",
  ...
  {
    book: "Ephesians",
    writtenWhen: "Traditionally dated to around AD 60–62, written during one of Paul's imprisonments (often identified with Rome) and closely tied to Colossians — the two letters share an imprisonment setting and the same courier, Tychicus, who is described as carrying both at once (Ephesians 6:21–22; Colossians 4:7–9). This date follows from the letter's own claim to be Paul's (1:1; 3:1) and its unanimous reception as Pauline in the early church, with no ancient writer known to have disputed it. Many critical scholars instead place it several decades later, in the last quarter of the first century, arguing that its distinctive vocabulary and style, its more settled and universal view of the church, and its close literary dependence on Colossians point to a later writer composing in Paul's name and tradition rather than Paul writing it alongside his own letter to Colossae.",
  ...
  {
    book: "Colossians",
    writtenWhen: "Traditionally dated to around AD 60–62, written from prison and closely linked with Philemon and Ephesians. The Philemon link is substantive, not superficial: the two letters share the same imprisonment, the same co-sender (Timothy), and an overlapping web of companions and greetings — Epaphras, Aristarchus, Mark, Demas, Luke, Archippus — that a forger would have had to construct for no obvious gain, and Colossians closes with Paul's own handwritten greeting (4:18), an authentication device consistent with a genuine letter dictated to a secretary. Scholars who question its authenticity instead point to vocabulary and sentence structure that differ from the undisputed letters and to a fuller expression of Christ's supremacy and the church as his body, and on those grounds tend to date it later in the first century, nearer to Ephesians; defenders answer that Paul appears to incorporate an existing hymn in 1:15–20 and to take up his opponents' own terms in 2:8–23, which would account for the shift in style without requiring a later, pseudonymous author.",
  ...
  },
{
  ...
  {
    book: "1 Peter",
    writtenWhen: "Traditionally dated to the early-to-mid 60s AD, near the end of Peter's life and around the time of persecution under Nero. Scholars who question Petrine authorship often place it several decades later — sometimes into the early second century — pointing especially to 4:14-16, where suffering 'as a Christian' is read by many as reflecting formal, empire-wide legal proceedings against Christians simply for bearing the name, the situation attested in Pliny the Younger's correspondence with the emperor Trajan (c. AD 112), rather than Nero's localized, non-legal persecution after Rome's fire in AD 64.",
    author: "Traditionally written by the apostle Peter, possibly with the help of a secretary — the letter itself mentions Silvanus (Silas) as the one 'through whom' it was written (5:12), which may account for its refined, LXX-fluent Greek, a style some critical scholars judge too polished for a Galilean fisherman even granting a secretary. Critical scholars also point to the letter's apparent literary dependence on Romans, Ephesians, and possibly 1 Clement, and — most significantly — to its picture of suffering 'as a Christian' (4:16), which many read as reflecting the kind of official persecution for the name itself later described in Pliny's correspondence with Trajan, rather than Nero's earlier, localized persecution. Evangelical scholars answer each point in turn: the secretary hypothesis accounts for the polished Greek; the echoes of Paul's letters reflect a shared vocabulary of early Christian teaching rather than demonstrated literary borrowing; and 4:14-16 need only describe informal social hostility and local mob action against believers — well attested even under Nero and consistent with the persecution already narrated in Acts — not a formal legal category that is only clearly attested decades later.",
  ...
  {
    book: "Jude",
    writtenWhen: "If written by Jude the brother of Jesus, it belongs to the second half of the first century, commonly dated to the AD 60s-80s, and its close relationship to 2 Peter figures into scholarly discussions of its date. Many critical scholars regard the letter as pseudonymous, pointing to Jude 17-18, where the author tells his readers to 'remember the predictions of the apostles of our Lord Jesus Christ' — language some read as treating the apostles as a settled, bygone authority rather than living contemporaries, implying the apostolic generation had already passed and pushing the letter into the late first or early second century. Evangelical scholars answer that remembering a teaching does not require decades of hindsight: Peter made a nearly identical prediction of end-times scoffers in the early-to-mid 60s (2 Peter 3:3), and Jude could easily be recalling that same apostolic teaching within his own lifetime, especially if he wrote after Peter and other apostles had already taught on the subject.",
    author: "Traditionally attributed to Jude (Judas), who identifies himself as 'a brother of James' — understood to mean James the leader of the Jerusalem church, making Jude another brother of Jesus. He humbly calls himself only a 'servant of Jesus Christ.' Most scholars accept this self-identification, though some — citing the letter's polished Greek and, more significantly, its reference in 17-18 to 'the predictions of the apostles' as something now being recalled — argue this reads like a later writer looking back on a closed apostolic era, and so treat the letter as pseudonymous. Evangelical scholars respond that the phrase describes remembering a prediction, not eulogizing a vanished generation; the wording fits comfortably within Jude's own lifetime if the letter was written even a decade or two after Peter and the other apostles had already taught these things in the 50s and 60s — which is exactly the traditional dating.",
  ...
  {
    book: "Revelation",
    writtenWhen: "Scholars discuss two main dating windows. Proponents of an earlier date under the emperor Nero, in the late AD 60s before Jerusalem's fall, point to internal clues: the measuring of the temple in 11:1–2, which some read as evidence the sanctuary was still standing; the count of kings in 17:9–10 ('five have fallen, one is, the other has not yet come'), which many interpreters work out to land on Nero or the chaotic succession just after him; and the number 666 in 13:18, which converts to 'Nero Caesar' when transliterated into Hebrew letters (a variant reading of 616 matches the Latin form of the same name). Proponents of the later, Domitianic date, in the mid-90s AD, point instead to Irenaeus's explicit patristic testimony that John's vision was seen 'toward the end of Domitian's reign' (Against Heresies 5.30.3), and to the internal picture in the letters to the seven churches (chapters 2–3) of relatively settled, prosperous, even complacent congregations — Laodicea's boast that it is rich and needs nothing (3:17) reads more naturally a generation after Nero's persecution than in its immediate aftermath — along with the intensifying imperial cult under Domitian that fits the beast-worship theme of chapter 13. The Domitian dating (around AD 95) remains the more traditional and widely held view.",
