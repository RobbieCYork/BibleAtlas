...
export const pois: PointOfInterest[] = [
  {
    ...
    archaeology: {
      note: "Excavation has been more or less continuous since the 1950s and has uncovered the Roman theater, a hippodrome, Herod's seaside palace, a monumental aqueduct, and the harbour. The harbour is the extraordinary part. Herod built Sebastos between about 22 and 15 BC on an open coast with no natural shelter, enclosing roughly 100,000 square metres behind two breakwaters, the southern one running some 500 metres out. To do it his engineers used hydraulic concrete, which sets under water, and imported the volcanic ash it needs - pozzolana - from Puteoli in Italy by the shipload. Underwater survey from the 1980s, above all the Caesarea Ancient Harbour Excavation Project associated with A. Raban and K. Holum, mapped what is left of it. It did not last: the breakwaters were built across a geological fault, the concrete bonded poorly to the local kurkar rubble, and the moles tilted and settled into the seabed. The jetties now lie several metres under water and the harbour was unusable long before the Byzantine period. The most cited find here is the Pilate Stone, a limestone block reused in the theater and recovered in 1961 by A. Frova's Italian expedition, carrying a damaged Latin dedication naming Pontius Pilatus as prefect of Judea. It is the only inscription naming him from his own lifetime, and it is what corrected the record on his title. It should be said as carefully as the stone deserves: it places a man of that name in that office in that province under Tiberius, and it does not speak to a single event in the Gospels. Caesarea is also where Paul was held for two years and heard by Felix and Festus, and where Peter was sent to the household of Cornelius - the administrative capital of the province, and the port Acts uses more than any other.",
      photos: [
        {
  ...
  },
  {
    ...
    archaeology: {
      note: "Y. Yadin's excavations of 1963-65 uncovered Herod's Northern and Western Palaces, the casemate wall, Roman-style bathhouses, ritual baths, storerooms, and a synagogue among the best preserved from the Second Temple period, along with fragments of biblical and sectarian scrolls. Outside the walls the Roman works survive almost intact: a circumvallation wall of some four kilometres, towers, eight camps, and the assault ramp on the western side, built on a natural spur. That much is solid, and it is a great deal. What the archaeology supports about the ending is a narrower question, and the honest answer is that it does not carry Josephus's account on its own. Josephus, who was not present, reports 960 dead by a chosen mass suicide. The remains of at most 28 people have been recovered on the mountain: three in the northern palace bathhouse and about 25 in a cave below the southern casemate. J. Zias has questioned even that second figure, since only a small fraction of the bone one would expect from 25 individuals was recovered, and pig bones were found among the remains, which points towards Roman burial practice rather than Jewish defenders. Yadin read eleven inscribed potsherds found near the northern palace as the lots drawn by the last men, one of them reading ben Ya'ir, which would be the rebel commander Josephus names; the reading of the sherds as the lots is an inference, not something the sherds say. S. Cohen catalogued the places where Josephus and the site disagree: he describes one palace where there are two, gets details of the northern palace wrong, exaggerates the walls and towers, and mentions a single fire where many buildings show burning. None of this shows that nothing happened here, and none of it makes Josephus worthless — he is the only narrative source there is, and the siege works he describes are lying on the ground. It shows that the specific ending, in the form it is usually retold, rests on Josephus rather than on the excavation, and that Yadin moved faster than the evidence did in tying the two together. N. Ben-Yehuda has written at length on how the story hardened into a national myth in the twentieth century. A visitor is standing on a genuine Herodian fortress that a Roman legion genuinely besieged; what happened in the last hours is a matter of one ancient historian's account, honestly reported as such.",
      photos: [
        {
    ...
    sources: [
      { label: "Masada - Wikipedia (the skeletal remains, the ostraca, and the debate over Josephus's account)", url: "https://en.wikipedia.org/wiki/Masada" },
      { label: "Masada - UNESCO World Heritage listing", url: "https://whc.unesco.org/en/list/1040/" },
      { label: "Biblical Archaeology Society: The Masada Siege", url: "https://www.biblicalarchaeology.org/daily/biblical-sites-places/biblical-archaeology-sites/the-masada-siege/" },
    ],
    reflectionPrompt:
  ...
  },
  {
    ...
    archaeology: {
      note: "V. Corbo of the Studium Biblicum Franciscanum led the first excavations from 1962 to 1967, uncovering the hilltop palace-fortress and its defensive towers; G. Foerster followed in 1968-69, and it is that season which produced the small copper-alloy ring later published as the Pilate Ring. E. Netzer of the Hebrew University then dug here across four decades from 1972. Finding Herod's burial place was the work of his career, and in May 2007, a month after the remains began to emerge, he announced at a press conference that he had found it: a ruined two-storey mausoleum on the slope, with fragments of three sarcophagi, one of them a reddish stone smashed into hundreds of pieces. Netzer died in October 2010 after a railing gave way at the site, three days after the fall, at the age of 76. R. Porat, who took over the excavation, has maintained the identification. It is disputed, and the dispute deserves stating rather than gesturing at. J. Patrich and B. Arubas set out four objections in the Palestine Exploration Quarterly in 2015: the mausoleum's dimensions are modest, roughly ten metres square and some twenty-five metres high, for the tomb of a king of Herod's reputation after more than thirty years on the throne; there is no appropriate gateway or assembly space in front of it; it stands in the shadow of the monumental stairway and off every axis of symmetry, invisible from Lower Herodium and from the direction of Jerusalem, which is not how Herod built; and a stratigraphic argument tells against it as well. Their own framing is that Netzer's account of Herodian architecture is right, and that this monument does not fit it. They add that they had hoped to walk the site with him and put the case in person, and that he died before they could. Their paper is hosted on the excavation project's own website, which is worth knowing about a dispute of this kind. Where the matter stands: a monumental Herodian-period mausoleum was certainly found, and whether it is Herod's own tomb is an open question between serious people.",
      photos: [
        {
    ...
    sources: [
      ...
      { label: "J. Patrich and B. Arubas, \"Revisiting the Mausoleum at Herodium: Is It Herod's Tomb?\", Palestine Exploration Quarterly 147/4 (2015), 299-315", url: "https://herodium.org/wp-content/uploads/2015/others/Patrich_Arubas_PEQ_147_4.pdf" },
      { label: "Ehud Netzer - Wikipedia (the 2010 accident at Herodium)", url: "https://en.wikipedia.org/wiki/Ehud_Netzer" },
  ...
  },
  {
    ...
    archaeology: {
      note: "Five expeditions have dug Tell es-Sultan: C. Warren's soundings of 1867-68, the Austrian-German expedition of E. Sellin and C. Watzinger in 1907-09 and 1911, J. Garstang in 1930-36, K. Kenyon in 1952-58, and the Italian-Palestinian expedition of L. Nigro and H. Taha since 1997. What nobody disputes is the Neolithic stone tower and wall of about 8000 BC, among the oldest monumental structures anywhere on earth. What is disputed is the date the last walled Bronze Age city burned, and that argument is the most contested question in biblical archaeology. Garstang found a burnt city he numbered City IV, found a collapsed double wall, and dated the fall to about 1400 BC — close enough to a fifteenth-century conquest to be read as Joshua 6 confirmed. Kenyon re-dug the same ground with finer stratigraphic control and reached a different answer, and it is worth stating plainly rather than softened: she assigned City IV to the end of the Middle Bronze Age, which in her assessment ended about 1580 BC, attributed its destruction to Egyptian campaigning at the start of the Eighteenth Dynasty, and concluded that the Late Bronze town on the mound was slight and unwalled, with no fortified city standing at the dates a conquest is usually placed. Garstang's collapsed double wall turned out to be Early Bronze Age, about a thousand years older than he thought, and that correction is conceded on all sides. Most of the field followed Kenyon and still does. B. Wood reopened the question in 1990, and his case deserves its own terms rather than a summary of its conclusion: he argued that Kenyon had dated City IV chiefly by what was missing — imported Cypriot ware she did not find in her trenches — which he called poor method, and that the local painted pottery, the bowls, cooking pots and dipper juglets she did excavate belong typologically to Late Bronze I, not to the Middle Bronze Age. Stratigraphy, a scarab series and a radiocarbon date were offered in support; the pottery was the argument. The reception is the other half, and leaving it out would be advocacy. P. Bienkowski answered him in the same journal that year and concluded the redating must be rejected, and the excavated radiocarbon evidence went against it as well: H. Bruins and J. van der Plicht dated six samples of charred grain from the destruction layer and wrote that the city was not destroyed by about 1400 BC as Wood had suggested, placing the fall in the late seventeenth or the sixteenth century BC. Wood's answer is that second-millennium radiocarbon dates run systematically early, which is itself a contested claim. Most archaeologists reject the redating; a minority, including T. Kennedy in a 2023 paper, still argue the Late Bronze I case. The question is open, and this page is not going to close it.",
      photos: [
        {
    ...
    sources: [
      { label: "H. Bruins and J. van der Plicht, \"Tell es-Sultan (Jericho): Radiocarbon Results ... from the End of the Middle Bronze Age,\" Radiocarbon 37:2 (1995), 213-220", url: "https://www.cambridge.org/core/journals/radiocarbon/article/tell-essultan-jericho-radiocarbon-results-of-shortlived-cereal-and-multiyear-charcoal-samples-from-the-end-of-the-middle-bronze-age/49BF732173E7890A2B0EC1B21CB6A817" },
      { label: "B. Wood, \"Did the Israelites Conquer Jericho?\", Biblical Archaeology Review 16:2 (March/April 1990)", url: "https://library.biblicalarchaeology.org/issue/march-april-1990/" },
      { label: "P. Bienkowski, \"Jericho Was Destroyed in the Middle Bronze Age, Not the Late Bronze Age\", and Wood's reply, Biblical Archaeology Review 16:5 (Sept/Oct 1990)", url: "https://library.biblicalarchaeology.org/issue/september-october-1990/" },
      { label: "Sapienza University of Rome: the Italian-Palestinian Expedition to Tell es-Sultan", url: "https://sites.google.com/uniroma1.it/sapienzatojericho/results/season-1997-2000" },
  ...
  },
  {
    ...
    archaeology: {
      note: "Four expeditions have dug Tel Shiloh. A. Schmidt took soundings in 1922; a Danish expedition under H. Kjaer worked three seasons in 1926, 1929 and 1932, ending when Kjaer died mid-season; S. Holm-Nielsen returned for final soundings in 1963 and the report appeared in 1969. I. Finkelstein excavated for Bar-Ilan University from 1981 to 1984 and published the final report in 1993; his sequence — eight strata from the Middle Bronze Age to the Byzantine period, a pillared Iron Age public building, more than twenty grain silos, and a destruction at the end of Iron I around 1050 BC — is still the framework everyone works in. Associates for Biblical Research have excavated the site since 2017 under S. Stripling. There is a live argument between the two most recent excavators, and it is better named than discovered elsewhere; both state their commitments openly and both deserve to be quoted rather than characterised. Finkelstein holds that the biblical united monarchy is a literary construct of much later Judahite writers, and said of this site that the story of the ark \"can teach us mainly about the world of the authors who lived centuries after the destruction of Iron I Shiloh.\" Associates for Biblical Research describes itself as a Christian apologetics ministry dedicated to demonstrating the historical reliability of the Bible, and Stripling has said \"we're taking the Bible as a serious historical document, but the evidence is what the evidence is.\" The recent seasons have produced real material — three altar horns, ceramic pomegranates, a faunal assemblage with almost no pig in the Israelite layers, storage rooms and a monumental building — and some of it is published in scholarly journals. Stripling connects it to the tabernacle, and is careful about what that can mean: \"we were never expecting to find the mishkan; it was made of animal skins, it would have decomposed.\" The identification of a structure at Shiloh with the tabernacle has so far been argued in the excavation's own magazine and in press interviews rather than in a peer-reviewed journal, and this app treats that difference the way it treats every other: an announcement is not a finding. What is not in dispute is that Iron Age Shiloh was a substantial place that came to a violent end, which is what Jeremiah 7 remembers about it.",
      photos: [
        {
  ...
  },
  {
    ...
    archaeology: {
      note: "Excavations from 1969 to 1976 under Y. Aharoni for Tel Aviv University, with the last season directed by Z. Herzog, and later work on the water system, uncovered a planned Iron Age fortified city with a casemate wall, a four-chambered gate and an elaborate underground water system. In 1973 the ashlar blocks of a large four-horned altar were recognised built into the wall of a Stratum II storehouse — dismantled carefully rather than smashed, three of its four horns intact. It is the best-preserved Israelite burnt-offering altar yet found, and who took it down is genuinely disputed: Y. Aharoni and Z. Herzog read it as Hezekiah's reform, Y. Yadin argued in 1976 for Josiah's, and N. Na'aman and others hold that the archaeological case for either reform has not been made. The Beersheba Horned Altar has its own article. One thing was not found here and its absence matters: no sanctuary building has ever been located at the site, and where it stood, or whether it existed, was the subject of a published exchange between Yadin and the excavators in 1976 and 1977.",
      photos: [
        {
  ...
  },
  {
    ...
    archaeology: {
      note: "Megiddo has been excavated more than almost any site in the land: G. Schumacher for the German Society for the Study of Palestine in 1903-05; the University of Chicago's Oriental Institute from 1925 to 1939 under C. S. Fisher, then P. L. O. Guy, then G. Loud; Y. Yadin for three short seasons between 1960 and 1971; and the Tel Aviv University expedition from 1992, begun by I. Finkelstein and D. Ussishkin and still running today. Roughly twenty occupation strata, monumental gates, palaces, two great pillared complexes and a rock-cut water system have come out of it. The \"Solomonic\" label came from Y. Yadin: after a six-chambered gate turned up at Hazor in the 1957 season he published the argument in 1958 that the near-identical six-chambered gates at Hazor, Megiddo and Gezer were the building work of 1 Kings 9:15, which names those three cities and no others. It was an elegant argument and it has not survived. Y. Aharoni showed in 1972, from Chicago's own report, that the Megiddo gate connects to the later Stratum IVA city wall, and D. Ussishkin argued in 1980 that the stratigraphy has to come first and the biblical verse second. Hardly anyone now dates the gate to Solomon. What is still argued, in print and recently, is narrower: the current excavators place its construction in Stratum VA-IVB in the ninth-century Omride period, and Ussishkin places it in the eighth. The pillared buildings have the same history. P. L. O. Guy cabled that he believed he had found Solomon's stables in 1928 and published them as Solomon's; they are now assigned to Stratum IVA, and whether they were stables at all is itself disputed — Y. Yadin, J. Holladay and G. Barkay have defended the identification, while J. B. Pritchard, Y. Aharoni, Z. Herzog, A. F. Rainey and others read them as storehouses or barracks. Ussishkin's own remark on all of it is worth keeping: in his view the date of the Megiddo gate has hardly any bearing on the larger question of what Solomon's kingdom was like.",
      photos: [
        {
  ...
  },
  {
    ...
    archaeology: {
      note: "The synagogue came to light in 2009 in a salvage excavation ahead of hotel building on the shore, directed for the Israel Antiquities Authority by D. Avshalom-Gorni and A. Najar; later seasons were run by the Kinneret Regional Project and by a Mexican team. It was in use before the destruction of the Second Temple in AD 70, which puts it among the small handful of synagogue buildings that were standing in Galilee during Jesus's own ministry, and it had frescoed walls and a mosaic floor. In September 2009 the same team lifted a stone bench in the main hall and found beneath it a carved limestone block about 60 cm long, now called the Magdala Stone. Its front carries a seven-branched menorah flanked by two-handled jars under an arch on pillars — the earliest known menorah carved by people who could have seen the real one in the temple — and its sides carry arcades and rosettes. What the block was for is genuinely open. Its excavators suggested a prayer table; M. Aviam reads it as the base of a table for reading the Torah; R. Hachlili has proposed an incense altar; R. Talgam and E. Reiner read the whole object as a three-dimensional evocation of Herod's temple, brought into a synagogue a long way from Jerusalem. M. Zapata-Meza has noted the plain difficulty that there is nothing else like it from the first century to compare it with, and D. Gurevich has argued for restraint, pointing out that rosettes and arcades also turn up in ordinary secular Herodian settings and do not automatically carry temple meaning. The town's identification as the Magdala of the Gospels is well supported. The link to Mary Magdalene rests on the place-name she is called by, not on any find here naming her, and readers should hold those two facts apart.",
      photos: [
        {
    ...
    sources: [
      ...
      { label: "D. Gurevich, \"Magdala's Stone of Contention\" - Bible and Interpretation, University of Arizona", url: "https://bibleinterp.arizona.edu/articles/2018/08/gur428008" },
  ...
  },
  {
    ...
    description: "A Latin paving-stone inscription reading ERASTVS PRO AEDILIT[AT]E S P STRAVIT (\"Erastus, in return for his aedileship, paved this at his own expense\") — the bracketed letters are restored, not on the stone. It is very often said to confirm the Erastus named in Romans 16:23, whom Paul calls the city's treasurer. It does not. The identification is an inference, it is genuinely contested, and the dispute runs as deep as which century the block belongs to.",
    archaeology: {
      note: "Found in 1929 by the excavation of the American School of Classical Studies at Athens under T. Leslie Shear, in situ in the paved plaza east of the theater's stage building at ancient Corinth, where it remains today — it is not in a museum. No individual finder is recorded. It was published as Corinth VIII.3, The Inscriptions 1926-1950 (1966), no. 232, whose mid-1st-century date most popular accounts assume without mentioning that it is disputed. S. J. Friesen (\"The Wrong Erastus,\" in Corinth in Context, 2010) argues the block sits in a secondary context and was probably not commissioned before the mid-second century AD, and that the Erastus of Romans was more likely a public slave. H. J. Cadbury called the identification improbable if not impossible in 1931, an oikonomos being typically a slave and an aedileship a higher office, and J. Meggitt argued the same point in 1996. On the other side, G. Theissen equated oikonomos with quaestor, an office freedmen did hold, which removes Cadbury's objection; J. K. Goodrich argued in 2010 that oikonomos tes poleos means municipal quaestor, a treasury magistrate of real rank; and D. W. J. Gill and B. Winter have defended the identification as well. A. D. Clarke has published a second Corinthian Erastus inscription, which complicates any one-to-one match: the name was not rare. Plausible, then, and worth knowing about — but not a confirmation.",
      photos: [
        {
  ...
  },
  {
    ...
    description: "Nine fragments of a Greek letter of the emperor Claudius to Delphi, naming \"Lucius Junius Gallio, my friend, and proconsul of Achaia\" (Acts 18:12) — the firmest date anywhere in Pauline chronology, and one that is routinely stated more precisely than the evidence allows. It fixes Paul in Corinth to within a year or two either side of AD 51; it does not fix the year itself.",
    archaeology: {
      note: "Fragments recovered by the French School at Athens in its excavations at the Temple of Apollo at Delphi in 1905, with further pieces identified afterwards; now in the Delphi Archaeological Museum. The whole was reassembled and re-edited by A. Plassart in the Revue des Etudes Grecques in 1967 and in Fouilles de Delphes III.4 in 1970, and that edition is the basis of all modern work on it. Two inferential steps sit between the stone and the usual \"AD 51-52\" for Paul's hearing, and they are worth naming. The emperor's titles in the letter — his twelfth tribunician power and twenty-sixth imperatorial acclamation — date the letter itself to roughly January 51 to August 52 CE, and most read it as 52. Gallio's proconsulship is then inferred from the letter, commonly as 1 July 51 to the summer of 52; Paul's appearance before him is then inferred from that term. There is more disagreement than popular accounts admit: Murphy-O'Connor argues for a tight window because Gallio left early for his health; H. D. Slingerland calls the early-departure argument speculative and rejects the narrow window; R. Novak allows a two-year term, which would open a range from late spring 50 to early summer 54 CE; and others simply date the proconsulship to 52/53. The honest formulation is a year or two either side of AD 51 — still the single firmest date in Pauline chronology, just not a precise one. Emile Bourguet is often named as the fragments' first publisher in 1905; that attribution could not be confirmed, so the excavating body is credited instead.",
      photos: [
        {
